...
import 'dashboard_screen.dart'; // Changed to Dashboard Screen
...
class _SystemOverviewScreenState extends State<SystemOverviewScreen> with AutomaticKeepAliveClientMixin, SingleTickerProviderStateMixin {
        ...
        actions: [
          Padding(
            ...
            child: ElevatedButton(
              ...
              child: Text("Dashboard".tr, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
            ),
          ),
        ],
      ),
